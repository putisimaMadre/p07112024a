...
@Component({
  selector: 'app-new-consentimiento-pdf',
  templateUrl: './new-consentimiento-pdf.component.html',
  styleUrl: './new-consentimiento-pdf.component.css'
})
export class NewConsentimientoPDFComponent implements OnInit{
